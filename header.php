...
$mv_bg = $current_slug . "-header-mv";
?>

<body>
    <div class="wrapper">
        <div class="header-mv <?php echo $mv_bg; ?> sub-header-mv">
            <header id="header">
                <div class="header-main">
                    ...
                    <div class="mv-header">
                        <div class="container">
                            <p class="mv-title"><?php echo the_title(); ?><span class="mv-eng-title"><?php echo ucfirst($current_slug); ?></span></p>
                            <div id="breadcrumb">
                                <div class="crumb">
                                    <ul class="crumb-in">
                                        <li>
